    ...
    <Link to="/" className="flex items-center" style={{ transform: `scale(${logoScale})`, transformOrigin: "left center", transition: "transform 0.35s ease", alignItems: "center" }}>
      {!logoFailed ? (
        <img
          ...
          style={{ height: 60, width: "auto", maxWidth: 150, objectFit: "contain", objectPosition: "left center", display: "block" }}
  ...
  return (
    <>
      ...
      >
        {/* ROW 1 */}
        <div
          className="min-h-[58px] md:min-h-[64px] pt-1 md:pt-1 pb-0"
          style={{
