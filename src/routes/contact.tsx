          ...
          >
            ...
            >
              ...
              <input type="email" style={inputStyle} placeholder="Email Address" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })}
                onFocus={(e) => (e.currentTarget.style.borderColor = BRAND.pink)}
                onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(230,0,126,0.2)")} />
              <input type="tel" style={inputStyle} placeholder="Phone Number" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })}
                onFocus={(e) => (e.currentTarget.style.borderColor = BRAND.pink)}
                onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(230,0,126,0.2)")} />
              ...
              <textarea rows={5} style={inputStyle} placeholder="Your Message" value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}
                onFocus={(e) => (e.currentTarget.style.borderColor = BRAND.pink)}
                onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(230,0,126,0.2)")} />
